...
package com.pumkinheadme.voicedshatteredpixeldungeon.desktop;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.pumkinheadme.voicedshatteredpixeldungeon.", "");
		...
		new Lwjgl3Application(new VoicedShatteredPixelDungeon(new DesktopPlatformSupport()), config);
	}
}
