...
package com.pumkinheadme.voicedshatteredpixeldungeon.android;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.services.news.NewsImpl;
import com.pumkinheadme.voicedshatteredpixeldungeon.services.updates.UpdateImpl;
...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			SPDSettings.set(instance.getPreferences("VoicedShatteredPixelDungeon"));
		...
		initialize(new VoicedShatteredPixelDungeon(support), config);
