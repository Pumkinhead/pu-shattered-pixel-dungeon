...
package com.pumkinheadme.voicedshatteredpixeldungeon.windows;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.BadgesGrid;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.BadgesList;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.CheckBox;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.ItemSlot;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.RedButton;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.RenderedTextBlock;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.TalentButton;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.TalentsPane;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.Button;
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)) {
					...
					protected void onClick() {
						super.onClick();
						VoicedShatteredPixelDungeon.scene().addToFront(new WndScoreBreakdown());
					}
				};
			...
			if (Dungeon.hero != null && Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						VoicedShatteredPixelDungeon.scene().addToFront(new WndOptions(new Image(icon),
		...
		public ChallengesTab(){
			...
			for (int i=0; i < Challenges.NAME_IDS.length; i++) {
				...
				IconButton info = new IconButton(Icons.get(Icons.INFO)){
					...
					protected void onClick() {
						super.onClick();
						VoicedShatteredPixelDungeon.scene().add(
