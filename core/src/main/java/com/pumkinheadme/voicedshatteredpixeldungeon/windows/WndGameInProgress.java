...
import com.pumkinheadme.voicedshatteredpixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				VoicedShatteredPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				VoicedShatteredPixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),
