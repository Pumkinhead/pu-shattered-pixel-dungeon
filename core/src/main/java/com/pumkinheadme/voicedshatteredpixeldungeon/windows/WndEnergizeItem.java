...
public class WndEnergizeItem extends WndInfoItem {
	...
	public static void energize( Item item ) {
		...
		if (VoicedShatteredPixelDungeon.scene() instanceof AlchemyScene){
			...
			((AlchemyScene) VoicedShatteredPixelDungeon.scene()).createEnergy();
	...
	public static WndBag openItemSelector(){
		if (VoicedShatteredPixelDungeon.scene() instanceof GameScene) {
			...
			VoicedShatteredPixelDungeon.scene().addToFront(window);
			return window;
		}
	}
		...
		public void onSelect(Item item) {
			if (item != null) {
				...
				if (VoicedShatteredPixelDungeon.scene() instanceof GameScene) {
					...
					VoicedShatteredPixelDungeon.scene().addToFront(new WndEnergizeItem(item, parentWnd));
				}
			}
		}
	};
