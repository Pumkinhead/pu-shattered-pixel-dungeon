...
package com.pumkinheadme.voicedshatteredpixeldungeon.actors.hero;

import com.pumkinheadme.voicedshatteredpixeldungeon.Assets;
import com.pumkinheadme.voicedshatteredpixeldungeon.Badges;
import com.pumkinheadme.voicedshatteredpixeldungeon.Bones;
import com.pumkinheadme.voicedshatteredpixeldungeon.Dungeon;
import com.pumkinheadme.voicedshatteredpixeldungeon.GamesInProgress;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.blobs.SacrificialFire;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.AdrenalineSurge;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Amok;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.AnkhInvulnerability;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Awareness;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Barkskin;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Barrier;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Berserk;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Bless;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Combo;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Drowsy;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Foresight;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.HoldFast;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Levitation;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.LostInventory;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.MindVision;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Momentum;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.MonkEnergy;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Paralysis;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.PhysicalEmpower;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Recharging;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Regeneration;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.SnipersMark;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.buffs.Vertigo;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.hero.abilities.ArmorAbility;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.hero.abilities.duelist.Challenge;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.hero.abilities.duelist.ElementalStrike;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.hero.abilities.huntress.NaturesPower;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.hero.abilities.warrior.Endure;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.mobs.Monk;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.mobs.Snake;
import com.pumkinheadme.voicedshatteredpixeldungeon.effects.CellEmitter;
import com.pumkinheadme.voicedshatteredpixeldungeon.effects.CheckedCell;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.Amulet;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.Ankh;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.Dewdrop;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.EquipableItem;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.Heap;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.Heap.Type;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.Item;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.KindOfWeapon;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.armor.Armor;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.armor.ClassArmor;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.armor.glyphs.AntiMagic;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.armor.glyphs.Brimstone;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.armor.glyphs.Viscosity;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.artifacts.AlchemistsToolkit;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.artifacts.CapeOfThorns;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.bags.MagicalHolster;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.journal.Guidebook;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.keys.CrystalKey;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.keys.GoldenKey;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.keys.IronKey;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.keys.Key;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.keys.SkeletonKey;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.exotic.PotionOfDivineInspiration;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.weapon.SpiritBow;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.journal.Document;
import com.pumkinheadme.voicedshatteredpixeldungeon.journal.Notes;
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.Level;
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.Terrain;
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.features.Chasm;
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.features.LevelTransition;
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.traps.Trap;
import com.pumkinheadme.voicedshatteredpixeldungeon.mechanics.ShadowCaster;
import com.pumkinheadme.voicedshatteredpixeldungeon.messages.Messages;
import com.pumkinheadme.voicedshatteredpixeldungeon.scenes.AlchemyScene;
import com.pumkinheadme.voicedshatteredpixeldungeon.scenes.GameScene;
import com.pumkinheadme.voicedshatteredpixeldungeon.scenes.InterlevelScene;
import com.pumkinheadme.voicedshatteredpixeldungeon.scenes.SurfaceScene;
import com.pumkinheadme.voicedshatteredpixeldungeon.sprites.CharSprite;
import com.pumkinheadme.voicedshatteredpixeldungeon.sprites.HeroSprite;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.AttackIndicator;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.BuffIndicator;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.QuickSlotButton;
import com.pumkinheadme.voicedshatteredpixeldungeon.ui.StatusPane;
import com.pumkinheadme.voicedshatteredpixeldungeon.utils.GLog;
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndHero;
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndMessage;
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndOptions;
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndResurrect;
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			VoicedShatteredPixelDungeon.switchScene(AlchemyScene.class);
			return false;
