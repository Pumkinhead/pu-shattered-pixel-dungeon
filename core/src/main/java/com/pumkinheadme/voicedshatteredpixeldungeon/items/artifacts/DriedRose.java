...
package com.pumkinheadme.voicedshatteredpixeldungeon.items.artifacts;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.blobs.CorrosiveGas;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.effects.particles.ShaftParticle;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.bags.Bag;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.scenes.CellSelector;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.sprites.GhostSprite;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndBlacksmith;
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndQuest;
...
public class DriedRose extends Artifact {
	...
	public String desc() {
		if (!Ghost.Quest.completed()
				&& (VoicedShatteredPixelDungeon.scene() instanceof GameScene || VoicedShatteredPixelDungeon.scene() instanceof AlchemyScene)){
	...
	public static class GhostHero extends DirectableAlly {
		...
		public void sayAppeared(){
			...
			if (VoicedShatteredPixelDungeon.scene() instanceof GameScene) {
				Sample.INSTANCE.play( Assets.Sounds.GHOST );
			}
		}
