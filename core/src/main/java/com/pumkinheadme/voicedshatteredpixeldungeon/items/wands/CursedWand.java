...
package com.pumkinheadme.voicedshatteredpixeldungeon.items.wands;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.blobs.ConfusionGas;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.blobs.Fire;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.blobs.ParalyticGas;
import com.pumkinheadme.voicedshatteredpixeldungeon.actors.blobs.Regrowth;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.traps.CursingTrap;
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.traps.ShockingTrap;
import com.pumkinheadme.voicedshatteredpixeldungeon.levels.traps.SummoningTrap;
			...
			case 2:
				...
				try {
					...
					if(Messages.lang() != Languages.ENGLISH){
						...
						VoicedShatteredPixelDungeon.runOnRenderThread(
								new Callback() {
									@Override
									public void call() {
										GameScene.show(
