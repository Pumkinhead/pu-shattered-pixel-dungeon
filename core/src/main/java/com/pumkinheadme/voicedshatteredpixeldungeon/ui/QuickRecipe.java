...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.ArcaneResin;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.LiquidMetal;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.Recipe;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.bombs.Bomb;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.food.Blandfruit;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.food.Food;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.food.MeatPie;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.food.StewedMeat;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.AlchemicalCatalyst;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.Potion;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.brews.BlizzardBrew;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.brews.CausticBrew;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.brews.InfernalBrew;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.brews.ShockingBrew;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfAquaticRejuvenation;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfArcaneArmor;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfDragonsBlood;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfHoneyedHealing;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfIcyTouch;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.elixirs.ElixirOfToxicEssence;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.potions.exotic.ExoticPotion;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.scrolls.Scroll;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.scrolls.exotic.ExoticScroll;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.Alchemize;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.AquaBlast;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.ArcaneCatalyst;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.BeaconOfReturning;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.CurseInfusion;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.FeatherFall;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.MagicalInfusion;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.PhaseShift;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.ReclaimTrap;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.Recycle;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.SummonElemental;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.TelekineticGrab;
import com.pumkinheadme.voicedshatteredpixeldungeon.items.spells.WildEnergy;
...
public class QuickRecipe extends Component {
	...
	public QuickRecipe(Recipe r, ArrayList<Item> inputs, final Item output) {
		...
		for (final Item in : inputs) {
			...
			curr = new ItemSlot(in) {
				...
				protected void onClick() {
					VoicedShatteredPixelDungeon.scene().addToFront(new WndInfoItem(in));
				}
			};
		...
		if (hasInputs) {
			...
			if (!(VoicedShatteredPixelDungeon.scene() instanceof AlchemyScene)) {
				arrow.enable(false);
			}
		} else {
		...
		this.output = new ItemSlot(output){
			@Override
			protected void onClick() {
				VoicedShatteredPixelDungeon.scene().addToFront(new WndInfoItem(output));
			}
		};
		if (!hasInputs){
	...
	public class arrow extends IconButton {
		...
		protected void onClick() {
			...
			((AlchemyScene) VoicedShatteredPixelDungeon.scene()).populate(ingredients, Dungeon.hero.belongings);
		}
