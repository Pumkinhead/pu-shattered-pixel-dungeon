...
package com.pumkinheadme.voicedshatteredpixeldungeon.messages;
...
public class Messages {
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.pumkinheadme.voicedshatteredpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
	...
	public static String format( String format, Object...args ) {
		try {
			...
			VoicedShatteredPixelDungeon.reportException( new Exception("formatting error for the string: " + format, e) );
			return format;
		}
	}
