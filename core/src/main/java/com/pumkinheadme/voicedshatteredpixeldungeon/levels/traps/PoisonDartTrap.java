...
import com.pumkinheadme.voicedshatteredpixeldungeon.items.weapon.missiles.darts.PoisonDart;
			...
			protected boolean act() {
				...
				if (target != null) {
					...
					if (Dungeon.level.heroFOV[pos] || Dungeon.level.heroFOV[target.pos]) {
						((MissileSprite) VoicedShatteredPixelDungeon.scene().recycle(MissileSprite.class)).
