...
import com.pumkinheadme.voicedshatteredpixeldungeon.effects.Fireball;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.services.news.News;
import com.pumkinheadme.voicedshatteredpixeldungeon.services.updates.AvailableUpdateData;
import com.pumkinheadme.voicedshatteredpixeldungeon.services.updates.Updates;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndSettings;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnPlay = new StyledButton(GREY_TR, Messages.get(this, "enter")){
			...
			protected void onClick() {
				if (GamesInProgress.checkAll().size() == 0){
					...
					VoicedShatteredPixelDungeon.switchNoFade( StartScene.class );
				}
			}
		...
		StyledButton btnRankings = new StyledButton(GREY_TR,Messages.get(this, "rankings")){
			@Override
			protected void onClick() {
				VoicedShatteredPixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		...
		StyledButton btnBadges = new StyledButton(GREY_TR, Messages.get(this, "badges")){
			@Override
			protected void onClick() {
				VoicedShatteredPixelDungeon.switchNoFade( BadgesScene.class );
			}
		};
		...
		StyledButton btnAbout = new StyledButton(GREY_TR, Messages.get(this, "about")){
			@Override
			protected void onClick() {
				VoicedShatteredPixelDungeon.switchScene( AboutScene.class );
			}
		};
	...
	private static class NewsButton extends StyledButton {
		...
		protected void onClick() {
			super.onClick();
			VoicedShatteredPixelDungeon.switchNoFade( NewsScene.class );
		}
	}
				...
				VoicedShatteredPixelDungeon.scene().addToFront(new WndOptions(
					...
					protected void onSelect(int index) {
						if (index == 0) {
							...
							VoicedShatteredPixelDungeon.switchNoFade( ChangesScene.class );
						}
					}
				});
	...
	private static class SettingsButton extends StyledButton {
		...
		protected void onClick() {
			...
			VoicedShatteredPixelDungeon.scene().add(new WndSettings());
		}
	}
	...
	private static class SupportButton extends StyledButton{
		...
		@Override
		protected void onClick() {
			VoicedShatteredPixelDungeon.switchNoFade(SupporterScene.class);
		}
	}
}
