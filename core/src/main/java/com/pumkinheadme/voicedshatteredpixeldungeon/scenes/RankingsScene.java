...
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndDailies;
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndRanking;
		...
		if (Rankings.INSTANCE.latestDaily != null) {
			IconButton btnDailies = new IconButton(Icons.CALENDAR.get()) {
				...
				protected void onClick() {
					VoicedShatteredPixelDungeon.scene().addToFront(new WndDailies());
				}
