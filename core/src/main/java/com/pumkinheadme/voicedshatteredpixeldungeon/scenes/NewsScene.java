...
import com.pumkinheadme.voicedshatteredpixeldungeon.services.news.NewsArticle;
...
import com.pumkinheadme.voicedshatteredpixeldungeon.windows.WndTitledMessage;
...
public class NewsScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnSite = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "read_more")){
			...
			protected void onClick() {
				...
				VoicedShatteredPixelDungeon.platform.openURI(link);
			}
		};
	...
	private static class ArticleButton extends StyledButton {
		...
		protected void onClick() {
			...
			VoicedShatteredPixelDungeon.scene().addToFront(new WndArticle(article));
		}
	}
